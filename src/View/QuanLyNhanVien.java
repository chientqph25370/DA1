...
public class QuanLyNhanVien extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton13.setText("QUẢN LÝ CA LÀM");
        ...
        jLabel5.setText("Số giờ làm / ngày:");

        jLabel6.setText("Ngày Sinh:");

        jLabel7.setText("SDT");

        jLabel8.setText("Lương phải trả:");
        ...
        txtLuongPhaiTra.setEnabled(false);
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGap(50, 50, 50)
                                        .addComponent(txtSoNgayLam, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtLuongPhaiTra, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    public QLNhanVien getFormData(){
        ...
        float soGioLam = Float.parseFloat(txtSoGioLam.getText());
        int soNgayLam = Integer.parseInt(txtSoNgayLam.getText());
        String ngaySinh = txtNgaySinh.getText();
        String sdt = txtSDT.getText();
        String vaiTro = cbbVaiTro.getSelectedItem().toString();
        boolean gioiTinh = rdoNam.isSelected();
        QLNhanVien q = new QLNhanVien(maNV, tenNV, diaChi, ngaySinh, sdt, soGioLam, gioiTinh, vaiTro, soNgayLam);
        return q;
    }
    ...
    public void fillTable(int i){
        QLNhanVien q = lists.get(i);
        txtMa.setText(q.getMaNV());
        txtName.setText(q.getTenNV());
        txtDiaChi.setText(q.getDiaChi());
        txtSoGioLam.setText(q.getSoGioLam() + "");
        txtSoNgayLam.setText(q.getSoNgayLam() + "");
        cbbVaiTro.setSelectedItem(q.getVaiTro());
        txtNgaySinh.setText(q.getNgaySinh());
        txtSDT.setText(q.getSdt());
        txtLuongPhaiTra.setText(q.getSoGioLam() * 20.000 * q.getSoNgayLam() + "");
