...
public class QLBanHangRepository {
    ...
    public boolean add(QLBanHang q) {
        ...
        try (Connection con = DBConnect.getConnection();
                PreparedStatement ps = con.prepareStatement(query);) {
            ps.setObject(1, q.getMaMonOrder());
            ps.setObject(2, q.getTenMonOrder());
            ps.setObject(3, q.getSoLuongMonOrder());
            ps.setObject(4, q.getGiaTienOrder());
            ps.setObject(5, q.getThongTinOrder());
